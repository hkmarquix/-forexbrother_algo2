...
extern double initlots = 0.04;// initial lot size 0.04;
double initlotstep = 0.04;//0.04;
double recoverPips = 100; // default val
double zcrecoverPips = 450;  // default val


extern double martingaletype = 2; // martingale style: 1 -> step method; 2 -> factor method
extern double martingalefactor = 1.5; // lot size grow factor : Wilson say x1.3 for each new order
extern bool boundMartingaleLotsizenotsmallerthanLastOrder = true;

extern double martingale_targetProfitForEachOrder = 0; // targetProfitForEachOrder 0 means disbale
extern double martingale_targetProfitForEachLot = 0; // targetProfitForEachLot 0 means disbale ::::: each 0.01 lot !!!!!!!!!!!!
extern double martingale_targetProfitTotalPips = 0; // targetProfitTotalPips 0 means disbale ::: << this will set TP for each order
double martingale_targetProfitDropForEachOrder = 0; // targetProfitDropForEachOrder 0 means disable : targetProfitDropForEachOrder
...
extern int martingale_lastordermin = 2; // start recover after 1st order : 20 means 20 minutes before the last recover order
extern int martingale_startrecover = 2; // min for each recover :  5 means start martingale logic after 5 minute
